...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 28 11:28:05 2017
...
As first and most important responsibility he wants to reconstruct the road system of Chefland.
 ...
 Chef wants to build some bi-directional roads connecting different cities such that 
 each city is connected to every other city (by a direct road or through some other intermediate city) 
 and starting from any city one can visit every other city in the country through these roads.
...
Help king Chef to find the minimum cost to build the new road system in Chefland 
such that every city is connected to each other.
